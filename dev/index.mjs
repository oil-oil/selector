...
const assetsDirectory = resolve(directory, "../dist/assets");
const publicBase = "/__selector_dev__";

const assets = new Map([
  ["/loader.js", { type: "text/javascript; charset=utf-8", file: join(directory, "loader.js") }],
...
/**
 * Makes Selector available on demand in a Vite development server.
 * The plugin is excluded from production builds by `apply: "serve"`.
 */
export default function selectorDev() {
  return {
    name: "selector-dev",
    apply: "serve",
